...
import whoBoysData from '../data/who_data_boys.json';

export const WHO_STANDARDS: WHOStandards = {
    weightForAge: { // kg
        boys: whoBoysData.weightForAge.boys,
        girls: [
    ...
    lengthForAge: { // cm
        boys: whoBoysData.lengthForAge.boys,
        girls: [
    ...
    headCircumferenceForAge: { // cm
        boys: whoBoysData.headCircumferenceForAge.boys,
        girls: [
